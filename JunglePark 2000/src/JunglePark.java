...
/**
 * This class create a Jungle Park game, it is the core part of the whole program.
 * It extends PApplet class
 * 
 * @author Mouna Kacem
 */
public class JunglePark extends PApplet {
  ...
  public void clear() {
    for (int i = 0; i < listGUI.size(); i++) {
      if (listGUI.get(i) instanceof Animal) { // check the object id animals or not
        listGUI.remove(i);
        i--;
      }
    }
