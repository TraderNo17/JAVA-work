...
/**
 * This class tests the functionality of the whole program. Total five methods will be implemented
 * in this class, and they tests five different parts of the game. It extends the JunglePark class.
 * 
 * @author Yida Wu
 */
public class JungleParkTests extends JunglePark {
  ...
  public static boolean test2isCloseMethod() {
    ...
    t1.setPositionX(400);
    t1.setPositionY(200);
    // Set second tiger at position(290,200)
    t2.setPositionX(300); // tiger is 110px away from another tiger.
    t2.setPositionY(200);
  ...
  public static boolean test1DeerScanForThreatMethod() {
    ...
    d.setPositionX(200);
    d.setPositionY(200);
    // Set first tiger at position(320,200)
    t1.setPositionX(320); // tiger is 120px away from deer
    t1.setPositionY(200);
    if (!d.scanForThreat(proximity)) { // bug! scanForThreat() should return true here
  ...
  public static boolean test2DeerScanForThreatMethod() {
    ...
    t1.setPositionX(400); // tiger is 200px away from deer
    t1.setPositionY(200);
    if (d.scanForThreat(proximity)) { // bug! scanForThreat() should return false here
